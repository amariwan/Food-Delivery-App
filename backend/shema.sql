...
CREATE TABLE IF NOT EXISTS sensors (
  ...
  sensor_name VARCHAR(55) NOT NULL,
  sensor_type VARCHAR(55) NOT NULL,
  ...
  data LONGTEXT NULL,
  show bit(1) NOT NULL,
  saveData bit(1) NOT NULL,
  DataRetentionPeriodInMonth VARCHAR(5) NOT NULL,
